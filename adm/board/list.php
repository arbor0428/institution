...
?>
				<tr> 
					...
					<td align='center'><a class="btn grn" href="javascript:reg_modify('<?=$uid?>');" style="padding:10px;margin:0 5px;">수정</a> <a class="btn red" href="javascript:click_del('<?=$title?>','<?=$uid?>')" style="padding:10px;margin:0 5px;">삭제</a></td>
				</tr>
<?
		$i--;
		$line_num++;
