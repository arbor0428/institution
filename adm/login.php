...
<style>
html,body{width:100%;height:100%;background-color:#f5f2f2;}
.ad-login-bt {width:100%;height:52px;background-color:#920800;line-height:52px;color:#ffffff;border-radius:4px; text-align:center; cursor:pointer;}
...
.form-group-2:focus {background-color: #fff;outline: 0;box-shadow: 0 0 0 0.2rem rgba(0, 0, 0, .05);}
