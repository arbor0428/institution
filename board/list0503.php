...
?>
				<tr <?=$bgcolor?> height='45'> 
					...
					<td width="9%" class='b-text-s' align='center'><?=$data01?></td>
					<td width="*" class='b-text-s b-text-tit' style='padding-left:15px;'><?=$lock_icon?>  <?=$btn_tit_view?> <?=$c_tot_num?> <?=$FileIcon?> <?=$B_NewIcon?></td>
...
<?
			...
			$name = Util::NameStrLast($name,2,'O');
?>
