...
?>
				...
				<tr <?=$bgcolor?> height='65' class='<?=$qna_box?>'> 
					...
					<td width='1080' style='padding-left:5px;font-size:18px;'>[<?=$name?>] <?=$btn_tit_view?></td>
					<td width='15%' align='center' class='b-text-s'>
						<a href="javascript:reg_modify('<?=$uid?>');"><img src="<?=$BTN_modify02?>" alt="수정"></a> 
						<a href="javascript:click_del('<?=$title?>','<?=$uid?>')"><img src="<?=$BTN_del02?>" alt="삭제" width="50" height="21"></a>
					</td>
				</tr>
