...
?>
					...
					<td width='50%' height='30' align='right'>
						...
						<input name="word" type="text" style='width:200px;height:30px;' value='<?=$word?>'> <a href='javascript:document.frm01.submit();'><img src='<?=$BTN_search?>' align='absmiddle' alt='검색'></a>
					</td>
				</td>
			</table>
		</td>
