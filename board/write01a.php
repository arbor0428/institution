...
function check_form(){
	form = document.FRM;
	<?
		if($table_id=='table_1661098010' && form.type.value == 'write'){
	?>
	if(!isOneCheckModal(form.check_1,"개인정보 수집 및 이용에 동의해 주십시오","fc1"))	return;
	<?
		}
	?>
...
<!--등록-->
	...
	<?
		if($table_id=='table_1661098010' && $type == 'write'){
			include'wirte01a_agree.php';
		}
	?>
	...
	?>
		...
		<?
			if($table_id=='table_1661098010'){ //커뮤니티 > 윤리신문고
		?>
		<div class="tbl-st-row clearfix"> 
			<div class="tbl-st-col col-1">상담구분</div>
			<div class="tbl-st-col col-2">
				<select name="data01" id="data01">
					<option <?if($data01=='학생인건비') echo'selected';?> value='학생인건비'>학생인건비</option>
					<option <?if($data01=='신문고') echo'selected';?> value='신문고'>신문고</option>
				</select>
			</div>
		</div>
		<?
		...
		<?
			if($table_id=='table_1661098057'){ //커뮤니티 > 상담문의
		?>
		<div class="tbl-st-row clearfix"> 
			<div class="tbl-st-col col-1">상담구분</div>
			<div class="tbl-st-col col-2">
				<select name="data01" id="data01">
					<option <?if($data01=='기술이전') echo'selected';?> value='기술이전'>기술이전</option>
					<option <?if($data01=='기술사업화') echo'selected';?> value='기술사업화'>기술사업화</option>
					<option <?if($data01=='가족회사') echo'selected';?> value='가족회사'>가족회사</option>
		...
		<div class="tbl-st-row-wrap clearfix">
			<div class="tbl-st-row clearfix"> 
				...
				<div class="tbl-st-col col-2"><input name="name" id="user_name" type="text" style='width:97%;' value="<?=$name?>"></div>
			</div>
			<div class="tbl-st-row clearfix"> 
	...
	<div class="tbl-st-row-wrap clearfix">
		<div class="tbl-st-row clearfix"> 
			<div class="tbl-st-col col-1">이메일</div>	<!--벨류수정-->
			<div class="tbl-st-col col-2">
				<input name="data02" type="text" style='width:97%;' value="<?=$data02?>">
			</div>
		</div>
		<div class="tbl-st-row clearfix"> 
			...
			<?
				if($table_id=='table_1661098010' || $table_id=='table_1661098057'){ //커뮤니티 > 윤리신문고 or 커뮤니티 > 상담문의
			?>
