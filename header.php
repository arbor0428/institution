...
<header id="header" class="header">
	<div class="h_top">
		<div class="h_center dp_sb">
			<div class="h_topThree dp_sb dp_c">
				...
				<div class="threeBx"><a class="dp_f dp_c dp_cc" href="https://nkuris.kw.ac.kr/nKuris/main/LoginPage.do" target="_blank" title="n-KURIS">n-KURIS<img src="/images/icon_exit.png" alt="바로가기"></a></div>
			</div>
			<div class="h_searchBox dp_f dp_c">
				<span><a href="/sub01/sub05.php" title="업무별 담당자">업무별 담당자</a></span>
				<div class="searchBtn">
	...
	<div class="h_bot">
		<div class="h_center dp_sb">
			<h1 class="logo"><a href="/" title="logo"><img src="/images/logo_c.png" alt="logo"></a></h1>
			<ul class="nav dp_f">
				<li>
					...
					<ul class="depth2">
						...
						<li><a href="/sub01/sub04.php" title="조직도">조직도</a></li>
				...
				<li>
					...
					<ul class="depth2">
						...
						<li><a href="/sub02/sub04.php" title="사업공고">사업공고</a></li>
						<li><a href="/sub02/sub05.php" title="입찰공고">입찰공고</a></li>
					</ul>
				</li>
				<li>
					<a href="/sub03/sub01.php" title="">특허사업화</a>
					<ul class="depth2">
				...
				<li>
					...
					<ul class="depth2">
						...
						<li><a href="/sub04/sub05.php" title="구리시청년창업지원센터">구리시청년창업지원센터</a></li>
						<li><a href="/sub04/sub06.php" title="강북청년창업마루">강북청년창업마루</a></li>
					</ul>
				</li>
				<li>
				...
				<li>
					<a href="/sub06/sub01.php" title="">부설기관</a>
					<ul class="depth2">
						<li><a href="/sub06/sub01.php" title="광운대 기술지주회사">광운대 기술지주회사</a></li>
					</ul>
				</li>
				<li>
	...
	<div class="m-navWrap">
		...
		<div class="m-navbox on">	
			...
			<div class="dp_sb goBtnWrap">
				...
				<div class="threeBx"><a class="dp_f dp_c dp_cc c_w" href="https://nkuris.kw.ac.kr/nKuris/main/LoginPage.do" target="_blank" title="n-KURIS">n-KURIS<img src="/images/icon_exit.png" alt="바로가기"></a></div>
			</div>
			<ul class="m-nav">
				<li>
					<a href="/sub01/sub01.php" title="">산학협력단 소개</a>
		...
		<div class="menuWrap dp_f dp_wrap">
			...
			<div class="menu">
				...
				<ul>
					...
					<li><a href="/sub04/sub06.php" title="구리시청년창업지원센터">- 구리시청년창업지원센터</a></li>
				</ul>
			</div>
			<div class="menu">
...
<div class="fixed_sideBar">
	...
	<form name='frm_searchQuick' id='frm_searchQuick' method='post' action="<?=$_SERVER['PHP_SELF']?>">
	<input type='text' style='display:none;' class="board-input">
	<div class="input_wrap dp_f dp_cc">
	...
	<a class="first_sideMenu" href="https://nkuris.kw.ac.kr/nKuris/main/LoginPage.do" target="_blank" title="연구지원시스템 바로가기">
	...
	<div class="sideMenu">
		<div class="hoverBx"><!--hover용 박스--></div>
		<a class="dp_sb dp_c" href="/sub02/sub01.php" title="연구 규정 및 지침">
	...
	<div class="sideMenu">
		<div class="hoverBx"><!--hover용 박스--></div>
		<a class="dp_sb dp_c" href="../pdf/20220902_12.pdf" target="_blank" title="구매/검수 안내 pdf파일 보기">
			<span>구매/검수 안내</span>
			<img src="/images/lnr-chevron-right-circle.png" alt="구매/검수 안내">
		</a>
	</div>
	<div class="sideMenu">
		<div class="hoverBx"><!--hover용 박스--></div>
		<a class="dp_sb dp_c" href="/sub01/sub05.php" title="업무별 담당자 안내">
